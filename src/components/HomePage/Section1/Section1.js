    ...
    <div ref={parentElementRef} className={classes.section1}>
      <div ref={childElementRef}>
        {isElementIntersecting ? (
            ...
            <div className={classes.section1FlexParent}>
              ...
              <div>
                <p className={classes.section1Text}>
                  ...
                  React, Hooks, GraphQL and design. <br /> When i'm not coding
                  or writing blog posts, i'm usually thrashing out licks on
                  guitar a la Stevie Ray Vaughan or on Twitter or you could
                  catch me on Youtube watching every and <br />
          ...
          <div
            className={["AnimationHidden", classes.section1FlexParent].join(
              " "
            )}
          >
            <div>
