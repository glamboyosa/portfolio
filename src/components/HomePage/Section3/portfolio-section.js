...
const PortfolioSection = () => {
  ...
  return (
    <div ref={parentElementRef} className={classes.portfolio}>
      <div ref={childElementRef}>
        {!isElementIntersecting ? (
          <div className="AnimationReveal">
            <h3 className={classes.portfolioHeadingPrimary}>
              Featured Projects
            </h3>
            <div className={classes.portfolioFlexContainer}>
              <div className={classes.portfolioCard}>
                <div
                  className={[
                    classes.portfolioImage,
                    classes.portfolioImage1,
                  ].join(" ")}
                />
                ...
                <div className={classes.portfolioSkills}>
                  ...
                  React, TypeScript, Apollo Client, Node, Express-GraphQL,
                  Stripe API & Styled-Components.
                </div>
                <p className={classes.portfolioDescription}>
                  Goal: The goal was to build an online shop using fullstack
                  GraphQL stack, cutting edge technologies and advanced
                  techniques with emphasis and the design and UX.
                </p>
              ...
              <div
                className={[
                  ...
                  classes.portfolioCardDesign,
                ].join(" ")}
              >
                <div
                  className={[
                    classes.portfolioImage,
                    classes.portfolioImage2,
                  ].join(" ")}
                ></div>
                ...
                <p className={classes.portfolioDescription}>
                  Goal: The goal of the project is to maintain a repo of
                  resuable CSS code that other developers can find useful when
                  building sites.
                </p>
                <div className={classes.portfolioLinks}>
                  <a
            ...
            <div className={classes.portfolioFlexContainer}>
              <div className={classes.portfolioCard}>
                ...
                <p className={classes.portfolioDescription}>
                  Goal: The goal was to design the UI consuming an API i built
                  for a fictional camp using advanced React and Redux techniques
                  & concepts.
                </p>
                <div className={classes.portfolioLinks}>
                  <a
