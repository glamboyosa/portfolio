...
const Frontend = () => (
  <Layout>
    ...
    <div className={classes.sections}>
      ...
      <p className={classes.portfolioParagraph}>
        Goal: The goal was to implement React techniques and concepts and create
        an app by consuming a news api.
      </p>
      <a
        className={classes.portfolioLink}
    ...
    <div className={classes.sections}>
      ...
      <p className={classes.portfolioParagraph}>
        ...
        concepts,techniques and tools like Webpack, Babel, classes, ES6+. <br />
